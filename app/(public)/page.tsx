    ...
    <div className="flex flex-col min-h-screen bg-slate-50/50 overflow-x-hidden">
      ...
      <section className="w-full py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-rows-2 grid-flow-col md:grid-rows-none md:grid-cols-2 lg:grid-cols-3 md:grid-flow-row gap-4 md:gap-8 overflow-x-auto md:overflow-visible no-scrollbar -mx-4 px-4 md:mx-0 md:px-0 snap-x touch-pan-x md:snap-none">
            {loading ? (
              [...Array(6)].map((_, i) => (
                <div
                  key={i}
      ...
      <section className="w-full py-24 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div
              ref={sliderRef}
              className="flex flex-nowrap overflow-x-auto no-scrollbar pb-10 -mx-4 px-4 gap-8 snap-x touch-pan-x md:mx-0 md:px-0"
            >
              {authors.length > 0 ? (
                authors.map((auth) => (
                  <div
